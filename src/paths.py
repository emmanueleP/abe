...
class PathManager:
    ...
    def setup_base_paths(self):
        ...
        # Directory specifiche per ogni applicazione
        self.ordina_dir = os.path.join(self.app_dir, "Ordina")
        self.avis_dir = os.path.join(self.app_dir, "aViS66")
        self.pdftoa_dir = os.path.join(self.app_dir, "PDFtoA")
        self.manrev_dir = os.path.join(self.app_dir, "ManRev")
        self.cbp_dir = os.path.join(self.app_dir, "CBP")
        self.agenda_dir = os.path.join(self.app_dir, "Agenda")
